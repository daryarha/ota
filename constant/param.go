...
const (
	DepartureDateInvalidFormat         = "departure_date, use yyyy-mm-dd format"
	...
	FilterDurationRangeMaxLowerThanMin = "filter duration range max is lower than min"
	ErrorInvalidParam                  = "Invalid param: %s"
)
